...
class bs4Navwalker extends Walker_Nav_Menu
{
    ...
    public function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
        ...
        */
        //
        $mtarget = get_field('modal_target', $item);
        $mtype = get_field('modal_type', $item);
        $item_output .= '<a ' . 'data-toggle='. '"' . $mtype . '"';
        $item_output .= 'data-target=' . '"' . $mtarget . '"';
